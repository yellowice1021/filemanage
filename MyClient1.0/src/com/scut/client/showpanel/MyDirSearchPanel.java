...
public class MyDirSearchPanel extends JPanel implements ActionListener 
{
	 ...
	 * Create the panel.
	 */
	public MyDirSearchPanel(DefaultTableModel historyTableModel, DefaultTableModel jobTableModel, JProgressBar progressbar) 
	{
