...
public class MyFileSearchPanelClient1 extends JPanel implements ActionListener 
{
...
//	Box box = Box.createHorizontalBox();  //横向box
	 ...
	 * Create the panel.
	 */
	public MyFileSearchPanelClient1(DefaultTableModel historyTableModel, DefaultTableModel jobTableModel, JProgressBar progressbar) 
	{
...
//		download.addActionListener(this);
	 ...
	 * 单独写一个普通用户检索的panle
	 * */
	public static void addFile1(String aimPath, String filename)
	{ 
		...
		//System.out.println("服务器端查询这里是文件名 " +filenames);
		log.debug(filenames);
