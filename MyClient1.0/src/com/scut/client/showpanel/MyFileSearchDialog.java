...
public class MyFileSearchDialog extends JDialog implements ActionListener{
...
//	}
	 ...
	 * Create the dialog.
	 */
	public MyFileSearchDialog(String aimPath) {
...
//		setContentPane(contentPanel);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
			MyFileSearchPanel.addFile(aimPath,textField.getText().trim());
			this.dispose();
		}
